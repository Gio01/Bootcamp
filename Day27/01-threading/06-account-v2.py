...
if __name__ == '__main__':
    ...
    '''
    Here it is the same lock usage but this is another manner in which we do not need
    to explicitely call the acquire() and the release() methods! with threading 
    Lock() and the self.lock it can do that on its own!'''