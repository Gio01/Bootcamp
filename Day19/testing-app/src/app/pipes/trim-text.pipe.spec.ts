...
describe('TrimTextPipe', () => {
    ...
    beforeEach(() => {
        ...
        pipe = TestBed.inject(TrimTextPipe) //creates the instance of pipe through injection
    })

    it('create an instance', () => {
        expect(pipe).toBeTruthy() //ensures that we have created the pipe instance! 
    })

    it('should return the given string if it is shorter than the max length', () => {
        //Arrange
        const shortInput = 'This is a short string'
        const expectedResult = 'This is a short string'
